...
NDefines.NGame.GAME_SPEED_SECONDS = { 1000.0, 0.3, 0.15, 0.04, 0.0 }
...
NDefines.NDiplomacy.VOLUNTEERS_PER_TARGET_PROVINCE = 1			    -- Volunteer shit to prevent 2w spam
NDefines.NDiplomacy.VOLUNTEERS_PER_COUNTRY_ARMY = 1				    -- Volunteer shit to prevent 2w spam
